...
<div>
	...
	<div class="banner">
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide" v-for="data in imgShowList"><a href="javascript:;"><img :src="data.imgUrl"/></a></div>
	...
	<div class="price-box">
		<div class="name-share">
			<p v-html="goodsDetail.goodsName2" class="name"></p>
		</div>
	...
	<div class="brand">
		...
		<div class="brand-der" v-else>全球商品一站式采购代发，主营美妆/个护/食品/保健品/日用品等品类,国内领先主流跨境电商平台的日系产品供应者。设有东京、电商平台的日系产品供应者。设有东京、香港、浙江三个中心。东京：采购与仓储 ; 香港：仓储与BD ; 浙江：运营与购与仓储 ; 香港：仓储与BD ;</div>
		<div class="brand-img" v-bind:class="{'company-img':!goodsDetail.brandStory}">
			<img :src="goodsDetail.brandLogo" width="100%" />
		</div>
		<div class="see-brand">
	...
	<div class="goods-details">
		<h2>商品图文说明</h2>
		<img v-for="data in imgList" :src="data.imgUrl" width="100%" height="100%" />
	</div>
...
export default{
	...
	mounted(){
      var oThis = this;
        ...
        this.detailMo();
       $(document).off().on('click','sku-con-item a',function(){
       	if($(this).hasClass('active')){
       		return
       	}
       	var index = $(this).index();
       	$('.sku-con-item a').removeClass('active');
	...
	methods:{
        ...
        goSure() {
            ...
            if ( this.isBuy ) {
                //跳转到支付页面
                commonMthods.setCookie('PALACE_ORDER_SKUNO', this.skuId);
                commonMthods.setCookie('PALACE_ORDER_NUMS', this.number);
                commonMthods.setCookie('PALACE_ORDER_COUPONID', "");
                commonMthods.setCookie('PALACE_ORDER_ADDRESS', "");
                commonMthods.setCookie('fromShop', 0);
        ...
        detailMo(){
        	...
        	$.ajax({
        		type:'post',
        		url:'https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/detailMo',
        		data:{
        		...
        		success:function(data){
                  //var data = data.data;
                   //alert(data.data.imgList[0]);
                   //alert(data.data);
                  oThis.goodsObj = data.data;
                  oThis.imgShowList = oThis.goodsObj.imgShowList;
                  //alert(oThis.goodsObj.imgShowList);
                  oThis.imgList = oThis.goodsObj.imgList;
                  oThis.origin = oThis.goodsObj.origin;
                  oThis.activityList = oThis.goodsObj.activityList;
                  oThis.goodsDetail = oThis.goodsObj.goodsDetail;
                  oThis.goodsDetails = oThis.goodsObj.detailList;
                  oThis.showSku = oThis.goodsObj.detailList[0];
                  oThis.skuId = oThis.showSku.skuId;
                  oThis.nowTime = oThis.goodsObj.nowTime;
        	...
        	$.ajax({
        		...
        		success:function(data){
        			if(data.data.success){
        				this.skuPrice = data.data.result;
        ...
        isCollect(){
        	...
        	$.ajax({
        		type:'post',
        		url:'https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/isCollect',
        		data:{
        ...
        insertCollect(){
        	...
        	$.ajax({
        		type:'post',
        		url:'https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/insertCollect',
        		data:{
        		...
        		success:function(data){
        			...
        			if( data.data.success ) {
        				if( data.data.message==='00000023' ) {
        					window.$toast({
        						msg : '已收藏'
        					});
        				} else if( data.data.message==='00000000' ) {
        					window.$toast({
        						msg : '收藏成功'
        					});
        					oThis.hasColltion = true;
        ...
        addShopCar(){
           ...
           $.ajax({
           	type:'post',
           	url:'https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/addShopcar',
           	data:{
