    ...
    <div  v-if="carList.length" class="settle-accounts" v-show="!isEditting">
        <div class="makes-box">
            ...
            <div class="all-money">
                ...
                <p class="money-tips">
                    <span>运费:￥</span><span class="total-post" v-html="selectedFreightMoney.toFixed(2)"></span>
                </p>
                <p class="money-tips">
...
import commonMthods from '../../js/common.js';
   ...
   export default{
   	...
   	methods:{
        ...
        choose: function(index1, index2) {
            ...
            //alert( !this.carList[index1]['shopCarList'][index2]['selected']);
            this.checkAllChoose();
        },
        ...
        deleteCar(id) {
            ...
            this.axios.post("https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/delShopcar",$.param({id:this.idList})).then( ( data ) => {
                var data = data.data;
                if (data.success) {
        ...
        addCar: function(goodsId, skuId, num) {
            this.axios.post("https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/addShopcar", $.param({
                goodsId: goodsId,
                skuId: skuId,
                num: num
            })).then( ( data ) => {});
        ...
        // 获取购物车数据
        getShopCar: function() {
            this.axios.post("https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/shopCar").then( ( data ) => {
                var data = data.data;
                //alert(data.data.carList);
                if(data.data.msg) {
                    this.isLoading = false;
                    if ( data.data.carList ) {
                        data.data.carList.forEach(function( item, index, arr) {
                            // 如果有活动才手动添加对应属性
                            if ( item.couponPolicyId > 0 ) {
                                item.isMeet = false;
                    ...
                    this.postpolicy = data.data.postpolicy;
                }
            });
        },
        ...
        carCount : function() {
            this.axios.post("https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/shopCar").then( ( data ) => {
                ...
                if(data.data.msg) {
                    if ( data.data.carList ) {
                        this.shopNum = data.data.carList.length;
                        //alert(data.data.carList.length);
                    } else {
                        this.shopNum = 0;
                    }
                }
