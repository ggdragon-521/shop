<template>
	...
	<!-- 商品关键词搜索 -->
		...
		<!-- 分类搜索 -->
		<com-navigation :headerName="$route.query.twoCategoryId" v-if="$route.query.twoCategoryId"></com-navigation>
    ...
    methods : {
        ...
        scrollGetData() {
           ...
           getGoodsList() {
            ...
            this.axios.post( 'https://www.easy-mock.com/mock/5a0bad8922eff44db04955c0/example_1510714761014/goodsResult', $.param(this.queryParams) )
            .then( (data) => {
